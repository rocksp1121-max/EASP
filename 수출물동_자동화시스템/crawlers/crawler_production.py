# -*- coding: utf-8 -*-
"""
crawler_production.py
생산계획(PS Order) 데이터 자동 추출

실행:
    python crawler_production.py
    python crawler_production.py --headless
...
SCREEN_NAME = "PS Order"           # ← 포털 검색어 (확인 필요)
OUTPUT_NAME = "생산계획(PS Order).xlsx"   # import_raw.py 기대 파일명
